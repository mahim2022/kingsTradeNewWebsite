...
const tiers = [
  ...
  },
  {
    ...
    description: [
      "Up to 15 hires",
      "Access to unskilled and semi-skilled labor",
  ...
  },
  {
    ...
    description: [
      "Unlimited hires",
      "Access to unskilled, semi-skilled, and specialized labor",
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: "text.secondary" }}>
          We offer tailored recruitment packages to fit your staffing needs,
          whether you require a few employees or an entire workforce.
          <br />
